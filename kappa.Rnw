...
<<global_option, echo=FALSE>>=
opts_knit$set(self.contained=FALSE)
opts_chunk$set(comment = NA, fig.width = 5, fig.height = 5, highlight = T, 
               background = "white")
@
...
\Sexpr{knit_child('chapters/0_background.Rnw')}
\Sexpr{knit_child('chapters/1_introduction.Rnw')}
