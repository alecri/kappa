...
\item To formalize and present an alternative one-stage random-effects method for dose-response meta-analysis of aggregated data, formulating the meta-analytic model in terms of a general linear mixed-effect model. 
