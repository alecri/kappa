...
\noindent A related problem directly affects the prediction of the pooled log relative risks. The maximum dose levels varies largely across studies, with values \Sexpr{paste(max_dose, collapse = ", ")} ml/day. 
